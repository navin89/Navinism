...
@Component({
  selector: 'app-pod-mobile',
  templateUrl: './pod.component.mobile.html',
  styleUrls: ['./pod.component.mobile.css']
})
export class PodComponentMobile extends BaseContextService implements OnInit {
