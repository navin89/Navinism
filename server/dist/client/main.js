...
var HomeComponent = /** @class */ (function (_super) {
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 21, vars: 4, consts: [[1, "home-wrapper"], [1, "header-wrapper"], [1, "title"], [1, "header-toolbar-wrapper"], [1, "spacer70"], [1, "body-wrapper"], [1, "podWrapper"], [1, "podTitle"], ["mat-card-image", "", "src", "http://navinism.org/image/getPicOfTheDay", "alt", "podImg", 1, "imageOfTheDay"], [1, "podDesc"], [1, "podCopyright"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
